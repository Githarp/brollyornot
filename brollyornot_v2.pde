...
TembooSession session = new TembooSession("hipzombies", "myFirstApp", "TTzp8K46KlzU4Dgvi1wjHfiswAkfzWGZ");
...
String accessToken = "15597971-s66vwAyIqEBBFbuFUL3cz9nDCISHB9OsyfEw9C3Zp";
String accessTokenSecret = "Pj8p0qFMJ1h6lt9OVzA2UQaP1BuAvX0wzHySrpkq179nT";
String APIkey = "KVYKAPKnyfhIMXPeU4hMAxACg";
String APISecret = "lJ51fBbqHeki4c56umbG5F8wlAF0lenU0QYp3uIqALVBDlhgi1";
...
void setup() {
  ...
  ArrayList test = getTweetsResults("raining");
  println("size of test = "+test.size());
 
  // run it again. should report less hits  
  test = getTweetsResults("raining");
  println("size of test = "+test.size());
